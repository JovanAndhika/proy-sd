...
function newGame(max, setWall) {
  ...
  document.getElementById('40').style.backgroundImage = "url('assets/zombie-turun.gif')";
...
function movePlayer() {
  ...
  if (from - next == 1) {
    document.getElementById(position).style.backgroundImage = "url('assets/zombie-kiri.gif')";
  } else if (from - next == -1) {
    document.getElementById(position).style.backgroundImage = "url('assets/zombie-kanan.gif')";
  } else if (from - next == 9) {
    document.getElementById(position).style.backgroundImage = "url('assets/zombie-atas.gif')";
  } else if (from - next == -9) {
    document.getElementById(position).style.backgroundImage = "url('assets/zombie-turun.gif')";
  }
